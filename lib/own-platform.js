  ...
  _createClass(OwnPlatform, [{
    ...
    value: function accessories(cb) {
      ...
      var _OwnAccessoryFactory$ = _ownAccessory.OwnAccessoryFactory.getAccessories(classes),
          LightOwnAccessory = _OwnAccessoryFactory$.LightOwnAccessory,
          AutomationOwnAccessory = _OwnAccessoryFactory$.AutomationOwnAccessory,
          TempSensorOwnAccessory = _OwnAccessoryFactory$.TempSensorOwnAccessory;
      ...
      var socket = new _ownSocket2.default(this.config.server, this.config.port, this.config.useConn);
      ...
      if (this.config.scanTempSensors) {
        var sensorsTry = (0, _lodash.times)(this.config.maxTempSensors, function (i) {
          return i + 1;
        });
